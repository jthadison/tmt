...
use risk_engine::{
    ...
    RiskAuditLogger, RiskConfig, RiskResponseSystem, RiskThresholds, WebSocketPublisher,
};
...
fn test_config_serialization() {
    ...
    assert_eq!(
        ...
        deserialized_config.margin_thresholds.warning_level
    );
    assert_eq!(
        config.drawdown_thresholds.daily_threshold,
        deserialized_config.drawdown_thresholds.daily_threshold
    );
}
